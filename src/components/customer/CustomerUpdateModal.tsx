...
import { X, Building2, User, Briefcase, MapPin, Phone, Printer, Globe } from "lucide-react";
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden animate-in fade-in zoom-in duration-200">
                ...
                <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-2xl font-bold text-white">Actualizar Cliente</h2>
                    </div>
                    <button
                        onClick={onClose}
